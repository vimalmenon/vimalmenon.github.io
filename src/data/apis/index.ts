import { IAPI, IExecuteWorkflow, INode, INodeSlim, IWorkflow, IWorkflowSlim } from '@types';
...
const ExecuteWorkflow = (id: string, body: IExecuteWorkflow): IAPI => ({
  body,
  method: 'PUT',
